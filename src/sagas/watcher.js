...
import {getCategories, getDecks, getFlashcards, deleteCategory,addCategory, editCategory, deleteDeck, addDeck, editDeck, addFlashcard, editFlashcard,deleteFlashcard} from './flashcard-sagas';
...
export default function* watchRequest() {
    ...
    yield takeEvery(types.DELETE_FLASHCARD, deleteFlashcard);
}
